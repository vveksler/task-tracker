...
every tech choice, and — most importantly — the "Edge case" note in each
phase: a deliberate edge case to find and fix, not just a feature to ship.
That's the part worth talking about in a design review.
...
> revocation check called out in the "Edge case" note, with a test for it.
...
> "Edge case" note, including a visible error state on failure.

Keep doing this per phase — always point Cursor at the specific "Edge case"
...
This section is what you actually walk an reviewer through.
